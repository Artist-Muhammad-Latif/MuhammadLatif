...
A dependency-free static portfolio for Muhammad Latif, featuring selected game work, professional experience, a downloadable CV, App Store and Google Play profiles, a direct WhatsApp contact, and an email contact form.
...
- Replace `assets/Muhammad-Latif-CV.pdf` to update the downloadable résumé while keeping the same filename.
...
The WhatsApp button opens a pre-filled conversation with Muhammad at the number listed in the CV.
